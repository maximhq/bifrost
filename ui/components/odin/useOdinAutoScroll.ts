...
interface UseOdinAutoScrollResult {
 ...
 * effect runs when React commits, but almost nothing in an Odin turn has its
 ...
 */
export function useOdinAutoScroll(): UseOdinAutoScrollResult {
