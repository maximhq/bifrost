import OdinPanel from "@/components/odin/odinPanel";
import { Sheet, SheetContent } from "@/components/ui/sheet";
import { useIsMobile } from "@/hooks/use-mobile";
import { useOdin } from "@/lib/contexts/odinContext";

/**
 * Wraps the app's content column so Odin can dock beside it.
 *
 * The dock narrows the page rather than floating over it, which is the whole
 * point: you ask Odin about the chart you are looking at, so the chart has to
