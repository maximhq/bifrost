 ...
 */
export default function OdinComposer({ isStreaming, disabled, provider, model, onSend, onStop }: OdinComposerProps) {
		...
		<div className="shrink-0 p-3">
			<div className="focus-within:border-ring bg-background flex flex-col gap-2 rounded-lg border p-2 transition-colors">
				...
				<div className="flex items-center justify-between gap-2">
					...
					<span className="text-muted-foreground flex min-w-0 items-center gap-1.5 px-1 text-xs" data-testid="odin-composer-model">
