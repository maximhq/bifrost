				...
				<div className="flex items-center gap-2 border-b p-3">
					...
					<DropdownMenu>
						<DropdownMenuTrigger asChild>
							<Button variant="outline" className="h-8 w-8 shrink-0 bg-transparent">
...
function DraggablePromptItem({ prompt, isSelected, href, onSelect, onEdit, onDelete }: DraggablePromptItemProps) {
	...
	return (
		<div
			ref={ref}
			className={cn(
				"group flex cursor-grab items-center gap-2 rounded-md px-2 py-1.5 active:cursor-grabbing",
