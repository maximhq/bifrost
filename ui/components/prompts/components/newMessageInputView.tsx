...
export function NewMessageInputView() {
	...
	return (
		<div
			className="group relative max-h-[500px] overflow-y-auto border-t px-4 py-2"
			{...(supportsVision
				? {
		...
		>
			...
			<div className="relative">
				<Textarea
					...
					onPaste={handlePaste}
					className="text-muted-foreground min-h-[60px] resize-none rounded-none border-0 bg-transparent p-0 pr-16 text-sm shadow-none focus-visible:ring-0 focus-visible:ring-offset-0"
