...
const createInitialState = (team?: Team | null): Omit<TeamFormData, 'isDirty'> => {
  return {
    ...
    // Budget
    budgetMaxLimit: team?.budget ? team.budget.max_limit / 100 : undefined, // Convert cents to dollars
    ...
    try {
      if (isEditing && team) {
        ...
        if (formData.budgetMaxLimit) {
          updateData.budget = {
            max_limit: Math.round((formData.budgetMaxLimit || 0) * 100), // Convert dollars to cents
