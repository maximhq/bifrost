...
const createInitialState = (customer?: Customer | null): Omit<CustomerFormData, 'isDirty'> => {
  return {
    name: customer?.name || '',
    // Budget
    budgetMaxLimit: customer?.budget ? customer.budget.max_limit / 100 : undefined, // Convert cents to dollars
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span>${(customer.budget.current_usage / 100).toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Budget Limit:</span>
                      <span>${(customer.budget.max_limit / 100).toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between">
