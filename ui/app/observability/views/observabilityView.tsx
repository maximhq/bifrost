...
const supportedPlatformsList = (resolvedTheme: string) => [
	{
		id: "otel",
		name: "Open Telemetry",
		icon: (
	...
	},
	{
		id: "maxim",
		name: "Maxim",
		icon: <Image src={`/maxim-logo${resolvedTheme === "dark" ? "-dark" : ""}.png`} width={19} height={19} alt="Maxim logo" />,
	},
	{
		id: "datadog",
		name: "Datadog",
		icon: <Image src="/images/datadog-logo.png" width={32} height={32} alt="Datadog logo" />,
		disabled: true,
	},
	{
		id: "newrelic",
