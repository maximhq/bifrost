...
const docSections = [
	{
		...
		badge: "Popular",
		items: ["HTTP Transport Setup", "Go Package Usage", "Docker Installation"],
	},
	{
		title: "Architecture",
		...
		items: ["System Overview", "Request Flow", "Concurrency Model", "Plugin Architecture"],
	},
	{
		title: "Usage Guides",
		...
		badge: "Comprehensive",
		items: ["Provider Configuration", "Key Management", "Error Handling", "MCP Integration"],
	},
	{
		title: "Contributing",
		...
		items: ["Development Setup", "Adding Providers", "Plugin Development", "Code Conventions"],
	},
	{
		title: "Examples",
		description: "Practical, executable examples for common use cases",
		icon: Code,
		url: "https://github.com/maximhq/bifrost/tree/main/docs/examples",
		items: ["End-to-end Examples", "Tool Calling", "MCP Scenarios", "Production Patterns"],
	},
	{
		title: "Benchmarks",
		description: "Performance metrics and optimization guides",
		icon: Zap,
		url: "https://github.com/maximhq/bifrost/blob/main/docs/benchmarks.md",
		items: ["Performance Benchmarks", "Latency Analysis", "Throughput Tests", "Optimization Tips"],
	},
];
			...
			<div className="mx-auto max-w-7xl p-8">
				<div className="space-y-8">
					...
					<div className="space-y-4 text-center">
						...
						<h1 className="text-4xl font-bold">Bifrost Documentation</h1>
