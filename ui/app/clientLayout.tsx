...
import OdinDock from "@/components/odin/odinDock";
...
import { OdinProvider } from "@/lib/contexts/odinContext";
					...
					<OdinProvider>
						<SidebarProvider>
							...
							<div className="flex h-dvh w-full min-w-0 flex-col">
								<Topbar />
								{/* Odin docks beside the content, never beside the topbar. The topbar
