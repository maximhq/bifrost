...
export default function VirtualKeySheet({ virtualKey, teams, customers, onSave, onCancel }: VirtualKeySheetProps) {
	...
	const watchedBudgetResetDuration = firstBudget?.reset_duration || "1M";
													...
													: watchedBudgetResetDuration === "1w"
														...
														: watchedBudgetResetDuration === "1M"
															...
															: watchedBudgetResetDuration === "1Y"
																? "year"
																: "period"}
												. The usage reset to $0.00 cannot be undone, but calendar alignment can be turned off later. This will take effect
												when you save.
											</AlertDialogDescription>
										</AlertDialogHeader>
										<AlertDialogFooter>
