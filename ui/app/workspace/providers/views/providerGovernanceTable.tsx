...
import { AlertTriangle, Clock, DollarSign, Gauge, RefreshCw, Shield, Zap } from "lucide-react";
			...
			<svg width={size} height={size} className="-rotate-90 transform">
				...
				<circle
					...
					className={cn(
						...
						isExhausted ? "text-red-500" : percentage > 80 ? "text-amber-500" : "text-emerald-500",
					)}
				/>
			</svg>
			<div className="absolute inset-0 flex items-center justify-center">
				<span className={cn("text-lg font-bold", isExhausted ? "text-red-500" : percentage > 80 ? "text-amber-500" : "text-foreground")}>
			...
			<div className="relative flex items-start justify-between gap-4">
				<div className="flex-1 space-y-3">
					<div className="flex flex-wrap items-center gap-2">
						<div className={cn("shrink-0 rounded-lg p-2", isExhausted ? "bg-red-500/10" : "bg-muted")}>
							<Icon className={cn("h-4 w-4", isExhausted ? "text-red-500" : "text-muted-foreground")} />
						</div>
