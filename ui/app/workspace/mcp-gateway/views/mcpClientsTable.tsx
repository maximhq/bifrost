							...
							const enabledToolsCount =
								c.state == "connected"
									? c.config.tools_to_execute?.includes("*")
										? c.tools?.length
										: c.config.tools_to_execute?.length && c.config.tools_to_execute?.length
											? c.config.tools_to_execute?.length
											: 0
									: 0;
							const autoExecuteToolsCount =
								c.state == "connected"
									? c.config.tools_to_auto_execute?.includes("*")
										? c.tools?.length
										: c.config.tools_to_auto_execute?.length && c.config.tools_to_auto_execute?.length
											? c.config.tools_to_auto_execute?.length
											: 0
									: 0;
							return (
								<TableRow
