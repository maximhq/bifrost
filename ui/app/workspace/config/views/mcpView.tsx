			...
			<div className="space-y-4">
				...
				<div className="space-y-4 rounded-sm border p-4">
					<div className="space-y-0.5">
						...
						<p className="text-muted-foreground text-sm">
							Override Bifrost's public base URL when it runs behind a reverse proxy. In most setups both URLs are the same — leave them
							blank to derive the URL from the incoming <code className="text-xs">Host</code> header. Both fields support env var syntax
