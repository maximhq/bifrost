...
export default function ImageView({ imageInput, imageOutput, isStreaming }: ImageViewProps) {
		...
		<div className="space-y-4">
			...
			{(currentImage || isStreaming) && (
				<div className="w-full rounded-sm border">
					...
					<div className="space-y-4 p-6">
						{!currentImage && isStreaming ? (
							<div className="font-mono text-xs">Generating image...</div>
						) : (
							currentImage && (
								<>
									...
									<ImageMessage 
										image={{
											...currentImage,
											output_format: imageOutput?.params?.output_format,
										}} 
										isStreaming={isStreaming && !currentImage} 
									/>
