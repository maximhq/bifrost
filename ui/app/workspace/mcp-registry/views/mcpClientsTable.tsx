			...
			<AlertDialog open={!!reregisterTarget} onOpenChange={(open) => !open && setReregisterTarget(null)}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Bifrost will register a new OAuth client with this server&apos;s provider and run the consent flow against it, replacing
							the client it currently uses. Use this when the provider no longer recognises the client it issued, which shows up as
