	...
	return (
		<div className="flex min-h-[80vh] w-full flex-col items-center justify-center gap-4 py-16 text-center">
			...
			<div className="flex flex-col gap-1">
				<h1 className="text-muted-foreground text-xl font-medium">{t("workspace.governance.customers.emptyTitle")}</h1>
				<div className="text-muted-foreground mx-auto mt-2 max-w-[600px] text-sm font-normal">
					{t("workspace.governance.customers.emptyDescription")}
				</div>
				<div className="mx-auto mt-6 flex flex-row flex-wrap items-center justify-center gap-2">
					<Button
						variant="outline"
						aria-label={t("workspace.governance.customers.readMoreAriaLabel")}
					...
					<Button
						aria-label={t("workspace.governance.customers.addFirstCustomerAriaLabel")}
						onClick={onAddClick}
						disabled={!canCreate}
