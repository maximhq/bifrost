	...
	const handleBulkDelete = async () => {
		...
		try {
			...
			if (failedIds.length > 0) {
				toast.error(deletedCount > 0 ? `${failedIds.length} team(s) could not be deleted.` : "Failed to delete the selected teams.");
						...
						<div className="border-border bg-secondary flex items-center justify-between rounded-md border px-4 py-3">
							...
							>
								<AlertDialogTrigger asChild>
									<Button variant="destructive" size="sm" disabled={!hasDeleteAccess || isBulkDeleting} data-testid="teams-bulk-delete-btn">
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										...
										<AlertDialogDescription>
											Are you sure you want to delete {selectedIds.size} team{selectedIds.size !== 1 ? "s" : ""}? This action cannot be
											undone.
										</AlertDialogDescription>
									</AlertDialogHeader>
									<AlertDialogFooter>
