				...
				<ChartCard
					...
					headerActions={
						<div className="flex items-center gap-3">
							...
							<ChartTypeToggle chartType={urlState.volume_chart as ChartType} onToggle={handleVolumeChartToggle} />
						</div>
					}
				>
					<LogVolumeChart
						data={histogramData}
						chartType={urlState.volume_chart as ChartType}
				...
				<ChartCard
					...
					headerActions={
						<div className="flex items-center gap-3">
							...
							<ChartTypeToggle chartType={urlState.token_chart as ChartType} onToggle={handleTokenChartToggle} />
						</div>
					}
				>
					<TokenUsageChart
						data={tokenData}
						chartType={urlState.token_chart as ChartType}
						startTime={urlState.start_time}
						endTime={urlState.end_time}
					/>
				</ChartCard>
				...
				<ChartCard
					...
					headerActions={
						<div className="flex items-center gap-3">
							...
							<ChartTypeToggle chartType={urlState.cost_chart as ChartType} onToggle={handleCostChartToggle} />
						</div>
					}
				>
					<CostChart
						data={costData}
						chartType={urlState.cost_chart as ChartType}
						startTime={urlState.start_time}
						endTime={urlState.end_time}
				...
				<ChartCard
					...
					headerActions={
						<div className="flex items-center gap-3">
							...
							<ChartTypeToggle chartType={urlState.model_chart as ChartType} onToggle={handleModelChartToggle} />
						</div>
					}
				>
					<ModelUsageChart
						data={modelData}
						chartType={urlState.model_chart as ChartType}
						startTime={urlState.start_time}
						endTime={urlState.end_time}
