...
// CEL expression validation schema
export const celExpressionSchema = z
	.string()
	.min(1, "CEL expression is required")
	.min(3, "CEL expression must be at least 3 characters")
	.max(5000, "CEL expression must be less than 5000 characters")
	.refine((expr) => !expr.includes(";;"), {
		message: "CEL expression contains invalid syntax (;;)",
	});
...
export const routingRuleSchema = z.object({
	...
	cel_expression: celExpressionSchema,
