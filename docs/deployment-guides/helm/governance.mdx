...
Token and request-count caps per time window. Referenced by ID from virtual keys, teams, customers, providers, or model limits.
...
bifrost:
  governance:
    rateLimits:
      ...
      # Model-level independent windows: 15 RPM + 1,500 RPD + 1M TPM + 10M TPD
      - id: "rl-platform-rpm"
        metric: "requests"
  ...
  governance:
    modelConfigs:
      ...
      - id: "mc-gpt4o-global"
        ...
        provider: "openai"
        budget_id: "budget-production"
        rate_limit_ids: ["rl-platform-rpm", "rl-platform-rpd", "rl-platform-tpm", "rl-platform-tpd"]
