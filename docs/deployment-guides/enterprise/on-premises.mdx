...
description: "Deploy Bifrost Enterprise in On-Premises or air-gapped environments using Docker credentials"
icon: "server"
---

Bifrost Enterprise supports On-Premises deployments for environments that cannot use cloud-native identity federation. Images are pulled from GCP Artifact Registry using username/password authentication.
