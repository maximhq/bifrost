...
Bifrost Enterprise provides private container image distribution through dedicated registries, enabling secure deployments in AWS, GCP, Azure, and On-Premises environments.
...
| On-Premises | GCP Artifact Registry | Basic auth with username/password credentials |
...
| On-Premises | [Basic Auth](/deployment-guides/enterprise/On-Premises) | Medium | Low |
...
<CardGroup cols={2}>
  ...
  <Card title="On-Premises" icon="server" href="/deployment-guides/enterprise/On-Premises">
