...
| `config.direct_key_cache_secret_env` | No | - | Environment variable containing a server-side HMAC secret (at least 32 bytes) for Direct Key cache partition isolation |
