...
| `connect_timeout_in_seconds` | integer | DNS + TCP dial timeout (default: 30). Bounds connection establishment separately from the request timeout so unreachable endpoints fail fast |
