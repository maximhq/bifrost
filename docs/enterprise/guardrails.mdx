---
title: "Overview"
description: "Enterprise-grade content safety and security validation with native regex, secrets detection, Presidio, Azure AI Language PII, AWS Bedrock Guardrails, Azure Content Safety, Google Model Armor, CrowdStrike AIDR, Gray Swan Cygnal, Patronus AI, and Lakera Guard."
icon: "road-barrier"
---
...
| Feature | Description |
|---------|-------------|
| **Multi-Provider Support** | Bifrost-native Custom Regex and Secrets Detection, plus Presidio, Azure AI Language PII, AWS Bedrock, Azure Content Safety, Google Model Armor, CrowdStrike AIDR, Gray Swan, Patronus AI, and Lakera Guard integrations |
...
| Capability | AWS Bedrock | Azure Content Safety | Google Model Armor | CrowdStrike AIDR | Gray Swan | Patronus AI | Lakera Guard | Azure AI Language PII | Presidio |
|------------|-------------|----------------------|--------------------|------------------|-----------|-------------|--------------|-----------------------|----------|
| PII Detection | Yes | No | Yes | Policy-dependent | No | Yes | Yes | Yes | Yes |
| Content Filtering | Yes | Yes | Yes | Policy-dependent | Yes | Yes | Yes | No | No |
| Prompt Injection | Yes | Yes | Yes | Policy-dependent | Yes | Yes | Yes | No | No |
| Hallucination Detection | No | No | No | No | No | Yes | No | No | No |
| Toxicity Screening | Yes | Yes | Yes | Policy-dependent | Yes | Yes | Policy-dependent | No | No |
| Custom Policies | Yes | Yes | Yes | Policy-dependent | Yes | Yes | Yes | Category filters | Entity filters |
| Custom Natural Language Rules | No | No | No | No | Yes | No | No | No | No |
| Image Support | Yes | No | No | No | No | No | No | No | No |
| IPI Detection | No | Yes | Yes | Policy-dependent | Yes | No | Policy-dependent | No | No |
| Mutation Detection | No | No | No | No | Yes | No | No | No | No |
| Bifrost-managed Redaction | No | No | No | No | No | No | Yes | Yes | Yes |
| Provider-managed Transformation | Yes | No | Yes | Policy-dependent | No | No | No | No | No |
