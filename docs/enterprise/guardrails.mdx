...
<CardGroup cols={2}>
  ...
  <Card title="Google Model Armor" icon="/media/google-model-armor.png" href="/integrations/guardrails/google-model-armor">
  ...
  <Card title="GraySwan Cygnal" icon="/media/grayswan-logo.png" href="/integrations/guardrails/grayswan">
    AI safety monitoring with natural language rule definitions.
  </Card>
  <Card title="Patronus AI" icon="/media/patronus-logo.png" href="/integrations/guardrails/patronus-ai">
