...
For file-driven deployments, the same allowlist can be declared under `scim_config.trusted_networks` in `config.json` instead of the dashboard - see [Trusted networks](/enterprise/user-provisioning#trusted-networks).
