...
Catch problems early with alerting:

<Card title="Alerting" icon="bell" href="/enterprise/alerting/overview">
  CEL-based alert rules over spend, error rate, latency, and API key health, delivered to Slack, Microsoft Teams, PagerDuty, and webhooks.
</Card>
