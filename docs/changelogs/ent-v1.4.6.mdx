...
- **New onboarding environments** - Provisioned new isolated customer deployment environments (Dockerfiles and Terraform hub infrastructure) for upcoming onboardings.
...
github.com/maximhq/bifrost/transports            v1.5.7
...
github.com/maximhq/bifrost/plugins/mocker        v1.5.15
