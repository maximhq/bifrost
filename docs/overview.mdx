...
<CardGroup cols={3}>
  ...
  <Card title="CoreWeave" icon="c" href="/providers/supported-providers/coreweave">
    Open-weight models on W&B Inference with OpenAI-compatible chat, text, and Responses APIs.
  </Card>
