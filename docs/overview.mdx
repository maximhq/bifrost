...
<CardGroup cols={2}>
  ...
  <Card title="Alerting" icon="bell" href="/enterprise/alerting/overview">
    CEL-based alert rules over spend, error rate, latency, and key health, delivered to Slack, Teams, PagerDuty, and webhooks.
  </Card>
