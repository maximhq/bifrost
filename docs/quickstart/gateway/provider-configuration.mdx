...
<Note>
  ...
  standard providers, it's optional and overrides the default endpoint. For AWS
  Bedrock, `base_url` applies only to bedrock-runtime inference; model listing,
  batch, Agent Runtime, S3, and Mantle use their service endpoints.
</Note>
