...
<Note>
**Backend-specific features**: Tool calling and vision capabilities depend on the underlying backend model. Claude and GPT models support tool calling; Gemini and Claude models support vision. The Responses API also supports native tool calling for Bedrock-backed models (Anthropic/Amazon) via the Converse API.
</Note>
