...
<Note>
**Unsupported Operations** (❌): Text Completions, Embeddings, List Models, Images, Files, Batch, and streaming voice are not offered by the upstream Sarvam API. These return `UnsupportedOperationError`.
</Note>
