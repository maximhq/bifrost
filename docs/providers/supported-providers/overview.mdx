...
- \* Deepgram real-time STT uses the native `GET /v1/listen` WebSocket (not HTTP `TranscriptionStream`). See [Deepgram](/providers/supported-providers/deepgram#2-live-listen-websocket-real-time-stt).
