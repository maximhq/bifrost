...
> **⚠️ IMPORTANT**: Before developing a plugin, **thoroughly read** the [Plugin Architecture Documentation](../architecture/plugins) to understand:
>
...
8. **Submit Plugin** - Follow the [contribution process](./README#-pull-request-process)
