...
3. **Override the base URL**
   ...
   For deployed instances, use your Bifrost deployment URL (e.g., `https://bifrost.example.com/openai`).
...
4. **Add custom models** (optional)
   ...
   Examples: `anthropic/claude-sonnet-4-5-20250929`, `openai/gpt-5`, `gemini/gemini-2.5-pro`
