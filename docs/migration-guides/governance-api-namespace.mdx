...
- `Deprecation: true`
- `Link: </api/governance/...>; rel="successor-version"`
- `X-Bifrost-Deprecated-Route`
- `X-Bifrost-Route-Removal: following-major-release`
...
5. Monitor deprecated-route telemetry until external alias traffic reaches zero.
6. Remove aliases only in the following major release.
