...
func TestVKDeletionCascadeComplete(t *testing.T) {
	...
	virtualKeysMap1 := data1["virtual_keys"].(map[string]interface{})
	...
	virtualKeysMap2 := data2["virtual_keys"].(map[string]interface{})
...
func TestTeamDeletionDeletesBudget(t *testing.T) {
	...
	data2 := getDataResp2.Body["data"].(map[string]interface{})
	teamsMap2 := data2["teams"].(map[string]interface{})
...
func TestCustomerDeletionDeletesBudget(t *testing.T) {
	...
	data2 := getDataResp2.Body["data"].(map[string]interface{})
	customersMap2 := data2["customers"].(map[string]interface{})
