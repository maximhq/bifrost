...
func TestInMemorySyncTeamUpdate(t *testing.T) {
	...
	data := getDataResp.Body["data"].(map[string]interface{})
	teamsMap := data["teams"].(map[string]interface{})
...
func TestInMemorySyncCustomerUpdate(t *testing.T) {
	...
	data := getDataResp.Body["data"].(map[string]interface{})
	customersMap := data["customers"].(map[string]interface{})
...
// TestDataEndpointConsistency tests that /api/governance/data endpoint returns consistent data
