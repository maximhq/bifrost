...
type UsageUpdate struct {
	...
	// Budgets and RateLimits are the limits this attempt answers to, resolved when its provider and
	// model were settled and carried here rather than worked out again at charging time. They travel
	...
	Budgets    []grants.Limit `json:"-"`
	RateLimits []grants.Limit `json:"-"`
