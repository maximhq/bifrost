...
func completeResourceSpan(span *ResourceSpan, timestamp time.Time, resp *schemas.BifrostResponse, bifrostErr *schemas.BifrostError, pricingManager *pricing.PricingManager) *ResourceSpan {
	...
	if resp != nil && resp.Usage != nil {
		...
		if resp.Usage.InputTokensDetails != nil {
			params = append(params, kvInt("gen_ai.usage.input_token_details.cached_tokens", int64(resp.Usage.InputTokensDetails.CachedTokens)))
		}
		if resp.Usage.OutputTokensDetails != nil {
			params = append(params, kvInt("gen_ai.usage.output_tokens_details.reasoning_tokens", int64(resp.Usage.OutputTokensDetails.ReasoningTokens)))
		}
		// Computing cost
