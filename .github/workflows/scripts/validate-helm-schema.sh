...
check_property_exists "semanticCache.direct_key_cache_secret_env" ".properties.bifrost.properties.plugins.properties.semanticCache.properties.config.properties.direct_key_cache_secret_env" "$HELM_SCHEMA"
