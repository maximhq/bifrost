...
export const Selectors = {
  ...
  sidebar: {
    ...
    providersLink: '[data-testid="nav-providers"]',
    virtualKeysLink: '[data-testid="nav-virtual-keys"]',
    logsLink: '[data-testid="nav-logs"]',
    mcpClientsLink: '[data-testid="nav-mcp-clients"]',
    userGroupsLink: '[data-testid="nav-user-groups"]',
    pluginsLink: '[data-testid="nav-plugins"]',
    configLink: '[data-testid="nav-config"]',
  },
  ...
  virtualKeys: {
    ...
    sheet: {
      ...
      addProviderBtn: '[data-testid="vk-add-provider-btn"]',
      providerConfigRow: (index: number) => `[data-testid="vk-provider-config-${index}"]`,
      
      // Budget
      budgetMaxInput: '[data-testid="vk-budget-max-input"]',
      budgetResetSelect: '[data-testid="vk-budget-reset-select"]',
      
      // Rate limits
      tokenMaxInput: '[data-testid="vk-token-max-input"]',
      tokenResetSelect: '[data-testid="vk-token-reset-select"]',
      requestMaxInput: '[data-testid="vk-request-max-input"]',
      requestResetSelect: '[data-testid="vk-request-reset-select"]',
