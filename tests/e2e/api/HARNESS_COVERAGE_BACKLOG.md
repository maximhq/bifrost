...
- [x] **Direct invoke** with Cohere-native embedding body — folder 55.C (PR #6335)
...
- [x] **Titan native InvokeModel typed envelopes** (`binary` alone and `float` + `binary`) — folder 55.A / 55.B (PR #6335)
...
- [x] **Cohere v4 native InvokeModel typed envelope** (`float`, `int8`, `uint8`, `binary`, `ubinary`) — folder 55.C (PR #6335)
- [x] **LangChain Cohere singular `embedding` alias** while preserving native plural `embeddings` — folder 55.D (PR #6335)
- [x] **Normalized Titan dual representations without raw-response leakage** — folder 55.E (PR #6335)
