	...
	t.Run("MultipleImages", func(t *testing.T) {
		...
		retryContext := TestRetryContext{
			...
			TestMetadata: map[string]interface{}{
				...
				"expected_keywords": []string{"different", "differences", "contrast", "unlike", "comparison", "compare"}, // 🎯 Comparison-specific terms
			},
		}

		// Enhanced validation for multiple image comparison (ant vs lion)
		expectations := VisionExpectations([]string{"animal", "different"}) // Basic expectation - should identify both as animals with differences
