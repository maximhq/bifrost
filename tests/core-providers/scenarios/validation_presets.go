...
func WeatherToolExpectations() ResponseExpectations {
	return ToolCallExpectations("get_weather", []string{"location"})
}
...
func ImageAnalysisExpectations() ResponseExpectations {
	...
	expectations.ShouldNotContainWords = []string{
