...
class TestOpenAIIntegration:
    ...
    @pytest.mark.parametrize(
        "provider,model,vk_enabled", get_cross_provider_params_with_vk_for_scenario("video_generation", include_providers=["runway"])
    )
    ...
    @pytest.mark.parametrize(
        "provider,model,vk_enabled", get_cross_provider_params_with_vk_for_scenario("video_generation", include_providers=["gemini"])
    )
