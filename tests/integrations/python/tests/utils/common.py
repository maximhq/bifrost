...
IMAGE_GENERATION_DETAILED_PROMPT = "A photorealistic image of a futuristic city skyline at night with flying cars and neon lights reflecting on wet streets"
