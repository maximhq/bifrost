...
func setupTestBifrostWithMCPConfig(ctx context.Context, mcpConfig *schemas.MCPConfig) (*bifrost.Bifrost, error) {
	...
	if mcpConfig.MaxAgentDepth == 0 {
		mcpConfig.MaxAgentDepth = 10
	}
	if mcpConfig.ToolExecutionTimeout == 0 {
		mcpConfig.ToolExecutionTimeout = 30
	}
...
// setupCodeModeClient creates an MCPClientConfig for a code mode client
func setupCodeModeClient(id, name string, toolsToExecute, toolsToAutoExecute []string) schemas.MCPClientConfig {
...
// setupNonCodeModeClient creates an MCPClientConfig for a non-code mode client
func setupNonCodeModeClient(id, name string, toolsToExecute, toolsToAutoExecute []string) schemas.MCPClientConfig {
	return schemas.MCPClientConfig{
		ID:                 id,
		Name:               name,
...
// setupClientWithAutoExecute creates an MCPClientConfig with auto-execute tools configured
func setupClientWithAutoExecute(id, name string, isCodeMode bool, toolsToExecute, toolsToAutoExecute []string) schemas.MCPClientConfig {
	return schemas.MCPClientConfig{
		ID:                 id,
		Name:               name,
...
// setupClientWithToolFilter creates an MCPClientConfig with tool filtering configured
func setupClientWithToolFilter(id, name string, isCodeMode bool, toolsToExecute []string) schemas.MCPClientConfig {
	return schemas.MCPClientConfig{
		ID:               id,
		Name:             name,
		IsCodeModeClient: isCodeMode,
