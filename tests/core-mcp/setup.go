...
// setupTestBifrost initializes and returns a Bifrost instance for testing with default MCP mode
func setupTestBifrost(ctx context.Context) (*bifrost.Bifrost, error) {
	return setupTestBifrostWithMode(ctx, schemas.MCPModeDefault)
}
...
func setupTestBifrostWithCodeMode(ctx context.Context) (*bifrost.Bifrost, error) {
	return setupTestBifrostWithMode(ctx, schemas.MCPModeCodeMode)
}

// setupTestBifrostWithMode initializes and returns a Bifrost instance for testing with specified MCP mode
func setupTestBifrostWithMode(ctx context.Context, mode schemas.MCPMode) (*bifrost.Bifrost, error) {
	account := &TestAccount{}

	// Provide a default fetchNewRequestIDFunc for testing
...
func setupTestBifrostWithMCPConfig(ctx context.Context, mcpConfig *schemas.MCPConfig) (*bifrost.Bifrost, error) {
	...
	// Ensure Mode is set if not provided
	if mcpConfig.Mode == "" {
		mcpConfig.Mode = schemas.MCPModeDefault
	}
