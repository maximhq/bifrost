...
class BifrostTestRunner:
    ...
    def __init__(self):
        ...
        self.integrations = {
            ...
            "litellm": {
                "file": "test_litellm_e2e.py",
                "description": "LiteLLM integration tests",
                "env_vars": ["OPENAI_API_KEY"],  # LiteLLM can use OpenAI key
            },
            "langchain": {
                "file": "test_langchain_e2e.py",
                "description": "LangChain integration tests",
                "env_vars": ["OPENAI_API_KEY"],
            },
            "langgraph": {
                "file": "test_langgraph_e2e.py",
                "description": "LangGraph integration tests",
                "env_vars": ["OPENAI_API_KEY"],
            },
            "mistral": {
                "file": "test_mistral_e2e.py",
                "description": "Mistral Python SDK integration tests",
                "env_vars": ["MISTRAL_API_KEY"],
            },
            "genai": {
                "file": "test_genai_e2e.py",
