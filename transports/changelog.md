...
- **Admin Password Redaction-Mask Collisions** - Valid admin passwords matching the generic 32-character secret mask are validated and hashed as new credentials instead of preserving the stored password
