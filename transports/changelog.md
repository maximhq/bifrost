...
- **Integration Stream Plugin Logs** — Integration and passthrough streaming traces now retain transport plugin logs when completing the trace after the stream finishes.
