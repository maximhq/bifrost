...
func (m *MockConfigStore) ClaimSidekiqJob(ctx context.Context, id, ownerID string, staleBefore time.Time) (bool, error) {
	return false, nil
}

func (m *MockConfigStore) HeartbeatSidekiqJob(ctx context.Context, id, ownerID string) (bool, error) {
	return false, nil
}

func (m *MockConfigStore) CompleteSidekiqJob(ctx context.Context, id, ownerID, metadata string) error {
	return nil
}

func (m *MockConfigStore) UpdateSidekiqJobProgress(ctx context.Context, id, ownerID, metadata string) error {
	return nil
}

func (m *MockConfigStore) FailSidekiqJob(ctx context.Context, id, ownerID, metadata, lastErr string) error {
	return nil
}
