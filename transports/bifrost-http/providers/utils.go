...
// Router defines the interface that all integration routers must implement
...
// ProviderRouter provides a reusable router implementation for all integrations.
...
// NewProviderRouter creates a new generic router with the given bifrost client and route configurations.
// Each integration should create their own routes and pass them to this constructor.
func NewProviderRouter(client *bifrost.Bifrost, routes []RouteConfig) *ProviderRouter {
...
func (g *ProviderRouter) RegisterRoutes(r *router.Router) {
...
func (g *ProviderRouter) createHandler(config RouteConfig) fasthttp.RequestHandler {
...
func (g *ProviderRouter) sendError(ctx *fasthttp.RequestCtx, err *schemas.BifrostError) {
...
func (g *ProviderRouter) sendSuccess(ctx *fasthttp.RequestCtx, response interface{}) {
