...
func (s *BifrostHTTPServer) loadBuiltinPlugins(ctx context.Context) error {
	builtinPlacement := ptrStr("builtin")
	...
	s.Config.SetPluginOrderInfo(telemetry.PluginName, builtinPlacement, ptrInt(1))
	...
	s.Config.SetPluginOrderInfo(logging.PluginName, builtinPlacement, ptrInt(2))
	...
	s.Config.SetPluginOrderInfo(governance.PluginName, builtinPlacement, ptrInt(3))
	...
	s.Config.SetPluginOrderInfo(otel.PluginName, builtinPlacement, ptrInt(4))
	...
	s.Config.SetPluginOrderInfo(semanticcache.PluginName, builtinPlacement, ptrInt(5))
	...
	s.Config.SetPluginOrderInfo(litellmcompat.PluginName, builtinPlacement, ptrInt(6))
	...
	s.Config.SetPluginOrderInfo(maxim.PluginName, builtinPlacement, ptrInt(7))
