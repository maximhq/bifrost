...
// answer stands. A key that names neither a customer nor a team is left unscoped on purpose:
// that is an admin-style key, and the whole deployment is what it is meant to see.
