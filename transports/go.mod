...
require (
	...
	github.com/maximhq/bifrost/plugins/governance v1.2.12
	github.com/maximhq/bifrost/plugins/logging v1.2.12
	github.com/maximhq/bifrost/plugins/maxim v1.3.2
	github.com/maximhq/bifrost/plugins/semanticcache v1.2.13
	github.com/maximhq/bifrost/plugins/telemetry v1.2.11
