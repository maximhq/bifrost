...
require (
	...
	github.com/maximhq/bifrost/plugins/maxim v1.6.3
	github.com/maximhq/bifrost/plugins/otel v1.2.3
	github.com/maximhq/bifrost/plugins/prompts v1.0.3
	github.com/maximhq/bifrost/plugins/semanticcache v1.5.3
	github.com/maximhq/bifrost/plugins/telemetry v1.5.3
