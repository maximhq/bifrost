...
require (
	...
	github.com/maximhq/bifrost/framework v1.0.22
	github.com/maximhq/bifrost/plugins/governance v1.2.15
	github.com/maximhq/bifrost/plugins/logging v1.2.15
	github.com/maximhq/bifrost/plugins/maxim v1.3.5
	github.com/maximhq/bifrost/plugins/semanticcache v1.2.17
	github.com/maximhq/bifrost/plugins/telemetry v1.2.14
