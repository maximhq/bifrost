- fix: complete Bedrock streaming Responses terminal events, response.completed now carries the output array, reasoning done events keep the accumulated thinking text and signature, citation annotations reach the done events and final snapshot, and structured-output streams emit a tracked text item (closes #5667) (thanks [@fus3r](https://github.com/fus3r)!)
