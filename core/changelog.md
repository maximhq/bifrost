- fix: preserve DeepSeek V4 Flash and Pro Anthropic effort, model, and usage fidelity, and reject unsupported image/document content before provider egress while preserving enumerated fallback [@valentinyanakiev](https://github.com/valentinyanakiev)
