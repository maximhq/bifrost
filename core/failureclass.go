...
// regionMarkers say the provider refuses the caller's location: Gemini's
// FAILED_PRECONDITION and Anthropic-on-Bedrock's ValidationException wording.
...
// might serve (a model this key cannot reach, a retired model) earn nothing here, and
// neither does a region block, which no retry can change.
