...
func (response *MistralListModelsResponse) ToBifrostListModelsResponse(rule schemas.ModelRule, aliases schemas.KeyAliases, unfiltered bool) *schemas.BifrostListModelsResponse {
	if response == nil {
		return nil
	}
