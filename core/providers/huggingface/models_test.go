...
func TestToBifrostListModelsResponse_AllowlistWithInferenceProviderSegment(t *testing.T) {
	...
	t.Run("matching provider emits single correctly-prefixed entry", func(t *testing.T) {
		...
		result := response.ToBifrostListModelsResponse(schemas.HuggingFace, featherlessAI, schemas.ModelRule{Allowed: allowlist}, nil, false)
	...
	t.Run("other providers do not duplicate the entry", func(t *testing.T) {
		...
		result := response.ToBifrostListModelsResponse(schemas.HuggingFace, cohere, schemas.ModelRule{Allowed: allowlist}, nil, false)
		require.NotNil(t, result)
...
func TestToBifrostListModelsResponse_AllowlistWithBasetenProviderSegment(t *testing.T) {
	...
	result := response.ToBifrostListModelsResponse(schemas.HuggingFace, provider, schemas.ModelRule{Allowed: allowlist}, nil, false)
	require.NotNil(t, result)
	require.Len(t, result.Data, 1)
...
func TestToBifrostListModelsResponse_AllowlistWithAutoPolicySegment(t *testing.T) {
	...
	t.Run("canonical first pass emits the auto-policy entry exactly once", func(t *testing.T) {
		t.Parallel()
		response := &HuggingFaceListModelsResponse{Models: nil}
		result := response.ToBifrostListModelsResponse(schemas.HuggingFace, INFERENCE_PROVIDERS[0], schemas.ModelRule{Allowed: allowlist}, nil, false)
		require.NotNil(t, result)
		require.Len(t, result.Data, 1)
	...
	t.Run("non-canonical passes do not duplicate the auto-policy entry", func(t *testing.T) {
		...
		response := &HuggingFaceListModelsResponse{Models: nil}
		result := response.ToBifrostListModelsResponse(schemas.HuggingFace, nonCanonicalProvider, schemas.ModelRule{Allowed: allowlist}, nil, false)
		require.NotNil(t, result)
