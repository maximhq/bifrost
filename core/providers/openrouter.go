...
func (provider *OpenRouterProvider) ListModels(ctx context.Context, key schemas.Key, request *schemas.BifrostListModelsRequest) (*schemas.BifrostListModelsResponse, *schemas.BifrostError) {
	response, rawResponse, latency, err := provider.handleOpenRouterModelListRequest(ctx, key)
	if err != nil {
		return nil, err
	}
...
func (provider *OpenRouterProvider) handleOpenRouterModelListRequest(ctx context.Context, key schemas.Key) (*schemas.BifrostListModelsResponse, interface{}, time.Duration, *schemas.BifrostError) {
	// Create request
