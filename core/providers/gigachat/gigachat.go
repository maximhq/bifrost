...
// VideoEdit is not supported by the GigaChat provider skeleton.
func (provider *GigaChatProvider) VideoEdit(_ *schemas.BifrostContext, _ schemas.Key, _ *schemas.BifrostVideoEditRequest) (*schemas.BifrostVideoEditResponse, *schemas.BifrostError) {
