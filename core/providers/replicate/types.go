...
type ReplicateMetrics struct {
	...
	InputTokenCount  *int     `json:"input_token_count,omitempty"`   // Number of input tokens
	OutputTokenCount *int     `json:"output_token_count,omitempty"`  // Number of output tokens
}
