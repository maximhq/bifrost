...
// OpenAI reads the model from the multipart session payload, not from the URL.
...
func (provider *OpenAIProvider) RealtimeWebRTCHeaders(authorization string) map[string]string {
	headers := map[string]string{}
	if authorization != "" {
