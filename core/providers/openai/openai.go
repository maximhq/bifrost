...
func (provider *OpenAIProvider) Responses(ctx *schemas.BifrostContext, key schemas.Key, request *schemas.BifrostResponsesRequest) (*schemas.BifrostResponsesResponse, *schemas.BifrostError) {
	...
	if oauthErr != nil {
		return nil, providerUtils.NewBifrostOperationError(oauthErr.Error(), oauthErr)
	}
...
func HandleOpenAIResponsesRequest(
	...
	if bodyTransformer != nil {
		...
		if transformErr != nil {
			return nil, providerUtils.NewBifrostOperationError(schemas.ErrRequestBodyConversion, transformErr)
		}
