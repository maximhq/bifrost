...
func (response *VertexListModelsResponse) ToBifrostListModelsResponse(rule schemas.ModelRule, aliases schemas.KeyAliases, unfiltered bool) *schemas.BifrostListModelsResponse {
	if response == nil {
		return nil
	}
...
func (response *VertexListPublisherModelsResponse) ToBifrostListModelsResponse(rule schemas.ModelRule, aliases schemas.KeyAliases, unfiltered bool) *schemas.BifrostListModelsResponse {
	if response == nil {
		return nil
	}
