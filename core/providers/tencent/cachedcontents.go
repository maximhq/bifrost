...
// CachedContentCreate is unsupported on TencentProvider. Only Gemini and Vertex
// AI implement the named cached-content lifecycle; Tencent TokenHub handles
// prompt caching implicitly via per-message cache markers.
...
// CachedContentList is unsupported on TencentProvider (see CachedContentCreate).
...
// CachedContentRetrieve is unsupported on TencentProvider (see CachedContentCreate).
...
// CachedContentUpdate is unsupported on TencentProvider (see CachedContentCreate).
...
// CachedContentDelete is unsupported on TencentProvider (see CachedContentCreate).
