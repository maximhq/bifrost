...
var toolSearchStreamEvents = []string{
	...
	`{"type":"content_block_start","index":1,"content_block":{"type":"tool_search_tool_result","tool_use_id":"srvtoolu_ts1","tool_references":[{"type":"tool_reference","tool_name":"get_weather"},{"type":"tool_reference","tool_name":"get_forecast"}]}}`,
...
var multiToolSearchStreamEvents = []string{
	...
	`{"type":"content_block_stop","index":2}`,
	`{"type":"content_block_start","index":3,"content_block":{"type":"tool_search_tool_result","tool_use_id":"srvtoolu_a","tool_references":[{"type":"tool_reference","tool_name":"tool_a"}]}}`,
	`{"type":"content_block_stop","index":3}`,
	`{"type":"content_block_start","index":4,"content_block":{"type":"tool_search_tool_result","tool_use_id":"srvtoolu_b","tool_references":[{"type":"tool_reference","tool_name":"tool_b"}]}}`,
	`{"type":"content_block_stop","index":4}`,
	`{"type":"content_block_start","index":5,"content_block":{"type":"tool_search_tool_result","tool_use_id":"srvtoolu_c","tool_references":[{"type":"tool_reference","tool_name":"tool_c"}]}}`,
