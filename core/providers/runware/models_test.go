...
func TestToBifrostListModelsResponse(t *testing.T) {
	out := ToBifrostListModelsResponse(catalogModels(), schemas.Runware, schemas.ModelRule{Allowed: schemas.WhiteList{"*"}}, nil, false)
...
func TestToBifrostListModelsResponse_RespectsKeyAllowlist(t *testing.T) {
	out := ToBifrostListModelsResponse(catalogModels(), schemas.Runware, schemas.ModelRule{Allowed: schemas.WhiteList{"tripo:v3.1@0"}}, nil, false)
