...
// DeepSeek provides OpenAI-compatible API endpoints with native thinking/reasoning
// support via the "thinking" toggle and "reasoning_effort" parameter.
package deepseek
...
// TextCompletion is not supported by the DeepSeek provider.
...
// TextCompletionStream is not supported by the DeepSeek provider.
...
// Responses performs a responses request via the DeepSeek chat API (Responses→Chat fallback).
...
// ResponsesStream performs a streaming responses request via the DeepSeek chat API.
...
// VideoDelete is not supported by the DeepSeek provider.
...
// VideoList is not supported by the DeepSeek provider.
...
// VideoRemix is not supported by the DeepSeek provider.
...
// BatchCreate is not supported by the DeepSeek provider.
...
// BatchList is not supported by the DeepSeek provider.
...
// BatchRetrieve is not supported by the DeepSeek provider.
...
// BatchCancel is not supported by the DeepSeek provider.
...
// BatchDelete is not supported by the DeepSeek provider.
...
// BatchResults is not supported by the DeepSeek provider.
...
// FileUpload is not supported by the DeepSeek provider.
...
// FileList is not supported by the DeepSeek provider.
...
// FileRetrieve is not supported by the DeepSeek provider.
...
// FileDelete is not supported by the DeepSeek provider.
...
// FileContent is not supported by the DeepSeek provider.
