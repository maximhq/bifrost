...
const (
	...
	// Token generation stopped because content was blocked by Model Armor (Vertex AI only).
	// Ref: https://docs.cloud.google.com/vertex-ai/generative-ai/docs/reference/rest/v1/GenerateContentResponse
	FinishReasonModelArmor FinishReason = "MODEL_ARMOR"
	// Token generation stopped because generated images contain prohibited content (Vertex AI only).
	FinishReasonImageProhibitedContent FinishReason = "IMAGE_PROHIBITED_CONTENT"
	// Token generation stopped because generated images triggered recitation (Vertex AI only).
	FinishReasonImageRecitation FinishReason = "IMAGE_RECITATION"
	// Token generation stopped for other image-related reasons (Vertex AI only).
	FinishReasonImageOther FinishReason = "IMAGE_OTHER"
	// Token generation stopped because no image was generated (Vertex AI only).
