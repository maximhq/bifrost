...
func (h *ToolsHandler) createReadToolFileTool() schemas.ChatTool {
...
func (h *ToolsHandler) handleReadToolFile(ctx context.Context, toolCall schemas.ChatAssistantMessageToolCall) (*schemas.ChatMessage, error) {
