...
func (m *CodeModeToolsHandler) createListToolFilesTool() schemas.ChatTool {
...
func (m *CodeModeToolsHandler) handleListToolFiles(ctx context.Context, toolCall schemas.ChatAssistantMessageToolCall) (*schemas.ChatMessage, error) {
