...
// No imports needed after removing custom JSON marshalers
...
type ResponsesAPIExtendedToolMessage struct {
...
type CustomToolFormat struct {
	...
	Text    *CustomToolTextFormat    `json:",omitempty"`
	Grammar *CustomToolGrammarFormat `json:",omitempty"`
}
