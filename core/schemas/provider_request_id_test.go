...
func TestResolveProviderRequestIDHeader(t *testing.T) {
	tests := []struct {
		...
		{name: "custom OpenAI base default", provider: ModelProvider("proxy"), config: &ProviderConfig{CustomProviderConfig: &CustomProviderConfig{BaseProviderType: OpenAI}, ProviderRequestID: &ProviderRequestIDConfig{Enabled: true}}, want: "x-request-id"},
		{name: "custom Anthropic base default", provider: ModelProvider("proxy"), config: &ProviderConfig{CustomProviderConfig: &CustomProviderConfig{BaseProviderType: Anthropic}, ProviderRequestID: &ProviderRequestIDConfig{Enabled: true}}, want: "request-id"},
		{name: "custom Azure base default", provider: ModelProvider("proxy"), config: &ProviderConfig{CustomProviderConfig: &CustomProviderConfig{BaseProviderType: Azure}, ProviderRequestID: &ProviderRequestIDConfig{Enabled: true}}, want: "apim-request-id"},
