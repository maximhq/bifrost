...
func ToCohereChatCompletionRequest(bifrostReq *schemas.BifrostRequest) *CohereChatRequest {
	...
	if bifrostReq.Params != nil {
		...
		if bifrostReq.Params.Tools != nil {
			cohereTools := make([]CohereChatRequestTool, len(bifrostReq.Params.Tools.ChatTools))
			for i, tool := range bifrostReq.Params.Tools.ChatTools {
		...
		if bifrostReq.Params.ToolChoice != nil {
			...
			if toolChoice.ToolChoiceStr != nil {
				toolChoice := CohereToolChoice(*toolChoice.ToolChoiceStr)
				cohereReq.ToolChoice = &toolChoice
			} else if bifrostReq.Params.ToolChoice.ChatToolChoice != nil {
				switch bifrostReq.Params.ToolChoice.ChatToolChoice.Type {
