...
type OpenAIConfig struct {
	...
	ChatGPTOAuth bool `json:"chatgpt_oauth"` // When true, routes requests through ChatGPT's backend API (chatgpt.com/backend-api/codex) for subscription-based access
}
