...
type CustomProviderConfig struct {
	...
	DisableDefaultVersionPath bool                   `json:"disable_default_version_path"`     // When true, strips the /v1 prefix from default paths for custom providers whose base URL already contains a path segment (e.g. Telnyx: /v2/ai/openai)
}
