...
type BifrostResponseExtraFields struct {
	RequestType    RequestType        `json:"request_type"` // TODO: populate these fields
	Provider       ModelProvider      `json:"provider"`
...
type BifrostErrorExtraFields struct { //TODO: populate these fields
	Provider       ModelProvider `json:"provider"`
	ModelRequested string        `json:"model_requested"`
