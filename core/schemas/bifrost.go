...
const (
	...
	BifrostContextKeyCompatNamespaceToolMap              BifrostContextKey = "bifrost-compat-namespace-tool-map"          // *compat.namespaceToolMap (set by compat plugin) BifrostContextKeyCompatNamespaceToolMap maps each flattened tool name back to the namespace and original name it was renamed from
