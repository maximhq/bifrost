...
const (
	...
	BifrostContextKeyRequestTimeout                      BifrostContextKey = "bifrost-request-timeout"                // time.Duration (total request/stream deadline override, independent of stream-idle-timeout)
	BifrostContextKeyRequestTimeoutFired                 BifrostContextKey = "bifrost-request-timeout-fired"          // bool (set by bifrost when the declared request-timeout deadline fires - DO NOT SET THIS MANUALLY)
