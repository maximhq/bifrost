...
const (
	...
	BifrostContextKeyOpencodeSession                     BifrostContextKey = "bifrost-opencode-session"                   // string (resolved x-opencode-session value, namespaced per virtual key; set once per request by the egress transport for the OpenCode provider family - DO NOT SET MANUALLY)
