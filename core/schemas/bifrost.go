...
const (
	...
	BifrostContextKeyProviderBaseURL                     BifrostContextKey = "bifrost-provider-base-url"                        // string (set by bifrost - DO NOT SET THIS MANUALLY) - network_config.base_url of the provider serving this attempt; empty means the provider default. Lets converters tell a vendor's own API apart from an OpenAI-compatible backend behind a custom base URL
