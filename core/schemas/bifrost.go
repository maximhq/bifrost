...
const (
	...
	BifrostContextKeyCodexCredentialPersister            BifrostContextKey = "bifrost-codex-credential-persister"               // CodexCredentialPersister (set by bifrost transport for persisting refreshed Codex credentials)
