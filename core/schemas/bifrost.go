...
const (
	...
	BifrostContextKeyOriginalClientBody                  BifrostContextKey = "bifrost-original-client-body"                     // []byte — raw HTTP body as received from the client (set by transport when log_pre_transform_request_data is enabled)
