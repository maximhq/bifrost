...
const (
	...
	BifrostContextKeyOpencodeSession                     BifrostContextKey = "bifrost-opencode-session"                   // string x-opencode-session affinity value for the request (set by the transport - DO NOT SET THIS MANUALLY) - forwarded ONLY by the opencode provider family, never via shared extra headers
