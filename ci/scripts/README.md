...
node git-operations.mjs commit-and-push "your commit message"

# Create and push a tag
node git-operations.mjs create-tag transports/v1.2.3

# Commit, push, and tag in one operation
node git-operations.mjs commit-and-tag "commit message" transports/v1.2.3
```
...
```bash
# Run transport build pipeline for core update
node run-pipeline.mjs transport-build core v1.2.3

# Run transport build pipeline for direct transport tag
node run-pipeline.mjs transport-build transport transports/v1.3.0
