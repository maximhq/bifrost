...
// syncWorkerTickerPeriod is the fixed wake-up interval for the composer's
// background sync worker. Independent of pricing SyncInterval — the ticker
// defines check granularity, not sync frequency.
const syncWorkerTickerPeriod = 1 * time.Hour
