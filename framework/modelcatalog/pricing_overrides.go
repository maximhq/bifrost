...
func patchPricing(pricing configstoreTables.TableModelPricing, override PricingOptions) configstoreTables.TableModelPricing {
	...
	for _, field := range []struct {
		...
		{dst: &patched.InputCostPerTokenAbove32kTokens, src: override.InputCostPerTokenAbove32kTokens},
		{dst: &patched.InputCostPerTokenAbove32kTokens, src: override.InputCostPerTokenAbove32kTokens},
		{dst: &patched.InputCostPerTokenAbove32kTokensPriority, src: override.InputCostPerTokenAbove32kTokensPriority},
		{dst: &patched.OutputCostPerTokenAbove32kTokens, src: override.OutputCostPerTokenAbove32kTokens},
		{dst: &patched.OutputCostPerTokenAbove32kTokensPriority, src: override.OutputCostPerTokenAbove32kTokensPriority},
		...
		{dst: &patched.InputCostPerTokenAbove256kTokens, src: override.InputCostPerTokenAbove256kTokens},
		{dst: &patched.InputCostPerTokenAbove256kTokensPriority, src: override.InputCostPerTokenAbove256kTokensPriority},
		{dst: &patched.OutputCostPerTokenAbove256kTokens, src: override.OutputCostPerTokenAbove256kTokens},
		{dst: &patched.OutputCostPerTokenAbove256kTokensPriority, src: override.OutputCostPerTokenAbove256kTokensPriority},
