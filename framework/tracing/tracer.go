...
// attributes that a connector registered a moment later would have wanted.
// Declaring an empty plugin set is what expresses "nothing is listening".
...
var fullTraceDemand = TraceDemand{Any: true, Content: true}
