...
func TestBuildResponsesMessageKeepsShellCallPayload(t *testing.T) {
			...
			StreamResponse: &schemas.BifrostResponsesStreamResponse{
				...
				Item: &schemas.ResponsesMessage{
					...
					ResponsesToolMessage: &schemas.ResponsesToolMessage{
						...
						ResponsesToolCallEnvelope: &schemas.ResponsesToolCallEnvelope{
	...
	shellCall := msgs[0].ResponsesToolMessage.ResponsesToolCallEnvelope
...
func TestBuildResponsesMessageKeepsShellCallOutput(t *testing.T) {
		...
		StreamResponse: &schemas.BifrostResponsesStreamResponse{
			...
			Item: &schemas.ResponsesMessage{
				...
				ResponsesToolMessage: &schemas.ResponsesToolMessage{
					...
					ResponsesToolCallEnvelope: &schemas.ResponsesToolCallEnvelope{MaxOutputLength: schemas.Ptr(1000)},
				},
			},
		},
	}}
	...
	require.Equal(t, 1000, *msgs[0].ResponsesToolMessage.ResponsesToolCallEnvelope.MaxOutputLength)
}
