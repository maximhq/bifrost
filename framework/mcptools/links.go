...
//
// framework/warp/links.go carries the same path for repairing links in Warp's
// own answer text (sanitizeAnswerLinks); that is about prose the model wrote,
// not tool results, so the two stay separate.
