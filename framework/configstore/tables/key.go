...
type TableKey struct {
	...
	ReplicateSigningSecret   *schemas.EnvVar `gorm:"type:text" json:"replicate_signing_secret,omitempty"`
...
func (k *TableKey) BeforeSave(tx *gorm.DB) error {
	...
	if k.ReplicateKeyConfig != nil {
		k.ReplicateSigningSecret = k.ReplicateKeyConfig.SigningSecret
		if k.ReplicateKeyConfig.SigningSecret != nil {
			k.ReplicateSigningSecret = k.ReplicateKeyConfig.SigningSecret.Redacted()
		}
...
func (k *TableKey) AfterFind(tx *gorm.DB) error {
	...
	if (k.ReplicateSigningSecret != nil) || (k.ReplicateDeploymentsJSON != nil && *k.ReplicateDeploymentsJSON != "") {
		replicateConfig := &schemas.ReplicateKeyConfig{}
		if k.ReplicateSigningSecret != nil {
			replicateConfig.SigningSecret = k.ReplicateSigningSecret
		}
		if k.ReplicateDeploymentsJSON != nil && *k.ReplicateDeploymentsJSON != "" {
			...
			replicateConfig.Deployments = nil
		}
