...
const (
	...
	SkillSourceTypeFilepath = "filepath"
...
type TableSkill struct {
	...
	FileCount int64 `gorm:"-" json:"file_count,omitempty"`
...
type TableSkillFile struct {
	...
	SourceFilepath *string   `gorm:"type:text;column:source_filepath" json:"source_filepath,omitempty"`
