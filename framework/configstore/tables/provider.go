...
type TableProvider struct {
	...
	ModelDiscoveryStatus string `gorm:"type:varchar(20);default:'unknown'" json:"model_discovery_status"`
	ModelDiscoveryError  string `gorm:"type:text" json:"model_discovery_error,omitempty"`
}
