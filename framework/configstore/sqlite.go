...
func (s *SQLiteConfigStore) UpdateClientConfig(ctx context.Context, config *ClientConfig) error {
...
func (s *SQLiteConfigStore) GetClientConfig(ctx context.Context) (*ClientConfig, error) {
...
func (s *SQLiteConfigStore) UpdateProvidersConfig(ctx context.Context, providers map[schemas.ModelProvider]ProviderConfig) error {
...
func (s *SQLiteConfigStore) UpdateProvider(ctx context.Context, provider schemas.ModelProvider, config ProviderConfig, envKeys map[string][]EnvKeyInfo) error {
	return s.db.Transaction(func(tx *gorm.DB) error {
...
func (s *SQLiteConfigStore) AddProvider(ctx context.Context, provider schemas.ModelProvider, config ProviderConfig, envKeys map[string][]EnvKeyInfo) error {
	return s.db.Transaction(func(tx *gorm.DB) error {
...
func (s *SQLiteConfigStore) DeleteProvider(ctx context.Context, provider schemas.ModelProvider) error {
	return s.db.Transaction(func(tx *gorm.DB) error {
		// Find the existing provider
		var dbProvider TableProvider
		if err := tx.WithContext(ctx).Where("name = ?", string(provider)).First(&dbProvider).Error; err != nil {
...
func (s *SQLiteConfigStore) GetProvidersConfig(ctx context.Context) (map[schemas.ModelProvider]ProviderConfig, error) {
...
func (s *SQLiteConfigStore) GetMCPConfig(ctx context.Context) (*schemas.MCPConfig, error) {
...
func (s *SQLiteConfigStore) UpdateMCPConfig(ctx context.Context, config *schemas.MCPConfig, envKeys map[string][]EnvKeyInfo) error {
	return s.db.Transaction(func(tx *gorm.DB) error {
...
func (s *SQLiteConfigStore) GetVectorStoreConfig(ctx context.Context) (*vectorstore.Config, error) {
...
func (s *SQLiteConfigStore) UpdateVectorStoreConfig(ctx context.Context, config *vectorstore.Config) error {
	return s.db.Transaction(func(tx *gorm.DB) error {
...
func (s *SQLiteConfigStore) GetLogsStoreConfig(ctx context.Context) (*logstore.Config, error) {
...
func (s *SQLiteConfigStore) UpdateLogsStoreConfig(ctx context.Context, config *logstore.Config) error {
	return s.db.Transaction(func(tx *gorm.DB) error {
...
func (s *SQLiteConfigStore) GetEnvKeys(ctx context.Context) (map[string][]EnvKeyInfo, error) {
...
func (s *SQLiteConfigStore) UpdateEnvKeys(ctx context.Context, keys map[string][]EnvKeyInfo) error {
	return s.db.Transaction(func(tx *gorm.DB) error {
...
func (s *SQLiteConfigStore) GetConfig(ctx context.Context, key string) (*TableConfig, error) {
...
func (s *SQLiteConfigStore) UpdateConfig(ctx context.Context, config *TableConfig, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) GetModelPrices(ctx context.Context) ([]TableModelPricing, error) {
...
func (s *SQLiteConfigStore) CreateModelPrices(ctx context.Context, pricing *TableModelPricing, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) DeleteModelPrices(ctx context.Context, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) GetPlugins(ctx context.Context) ([]TablePlugin, error) {
...
func (s *SQLiteConfigStore) GetPlugin(ctx context.Context, name string) (*TablePlugin, error) {
...
func (s *SQLiteConfigStore) CreatePlugin(ctx context.Context, plugin *TablePlugin, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) UpdatePlugin(ctx context.Context, plugin *TablePlugin, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	var localTx bool
...
func (s *SQLiteConfigStore) DeletePlugin(ctx context.Context, name string, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) GetVirtualKeys(ctx context.Context) ([]TableVirtualKey, error) {
...
func (s *SQLiteConfigStore) GetVirtualKey(ctx context.Context, id string) (*TableVirtualKey, error) {
...
func (s *SQLiteConfigStore) UpdateVirtualKey(ctx context.Context, virtualKey *TableVirtualKey, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) DeleteVirtualKey(ctx context.Context, id string) error {
	return s.db.WithContext(ctx).Delete(&TableVirtualKey{}, "id = ?", id).Error
}

// GetTeams retrieves all teams from the database.
func (s *SQLiteConfigStore) GetTeams(ctx context.Context, customerID string) ([]TableTeam, error) {
...
func (s *SQLiteConfigStore) GetTeam(ctx context.Context, id string) (*TableTeam, error) {
	var team TableTeam
...
func (s *SQLiteConfigStore) CreateTeam(ctx context.Context, team *TableTeam, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) UpdateTeam(ctx context.Context, team *TableTeam, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) DeleteTeam(ctx context.Context, id string) error {
	return s.db.WithContext(ctx).Delete(&TableTeam{}, "id = ?", id).Error
}

// GetCustomers retrieves all customers from the database.
func (s *SQLiteConfigStore) GetCustomers(ctx context.Context) ([]TableCustomer, error) {
...
func (s *SQLiteConfigStore) GetCustomer(ctx context.Context, id string) (*TableCustomer, error) {
...
func (s *SQLiteConfigStore) CreateCustomer(ctx context.Context, customer *TableCustomer, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) UpdateCustomer(ctx context.Context, customer *TableCustomer, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) DeleteCustomer(ctx context.Context, id string) error {
...
func (s *SQLiteConfigStore) GetRateLimit(ctx context.Context, id string) (*TableRateLimit, error) {
...
func (s *SQLiteConfigStore) CreateRateLimit(ctx context.Context, rateLimit *TableRateLimit, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) UpdateRateLimit(ctx context.Context, rateLimit *TableRateLimit, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) UpdateRateLimits(ctx context.Context, rateLimits []*TableRateLimit, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) GetBudgets(ctx context.Context) ([]TableBudget, error) {
...
func (s *SQLiteConfigStore) GetBudget(ctx context.Context, id string, tx ...*gorm.DB) (*TableBudget, error) {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) CreateBudget(ctx context.Context, budget *TableBudget, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) UpdateBudgets(ctx context.Context, budgets []*TableBudget, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) UpdateBudget(ctx context.Context, budget *TableBudget, tx ...*gorm.DB) error {
	var txDB *gorm.DB
	if len(tx) > 0 {
		txDB = tx[0]
	} else {
...
func (s *SQLiteConfigStore) GetGovernanceConfig(ctx context.Context) (*GovernanceConfig, error) {
	var virtualKeys []TableVirtualKey
	var teams []TableTeam
	var customers []TableCustomer
	var budgets []TableBudget
...
func (s *SQLiteConfigStore) ExecuteTransaction(ctx context.Context, fn func(tx *gorm.DB) error) error {
	return s.db.WithContext(ctx).Transaction(fn)
}

// doesTableExist checks if a table exists in the database.
func (s *SQLiteConfigStore) doesTableExist(ctx context.Context, tableName string) bool {
	var count int64
	if err := s.db.WithContext(ctx).Raw("SELECT COUNT(*) FROM sqlite_master WHERE type='table' AND name=?", tableName).Scan(&count).Error; err != nil {
		return false
	}
	return count > 0
}
...
func (s *SQLiteConfigStore) removeNullKeys(ctx context.Context) error {
...
func (s *SQLiteConfigStore) removeDuplicateKeysAndNullKeys(ctx context.Context) error {
