...
type ConfigStore interface {
	...
	// with status='pending', regardless of caller identity. Used by the
	// sessions list endpoint to surface pending submission flows alongside
	// completed credentials. Mirrors ListAllPendingOauthUserSessions on the
	// OAuth side. Row-visibility scoping is applied by wrappers downstream.
