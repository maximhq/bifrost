...
// migrationAddTeamSourceIDColumn adds optional source_id to governance_teams and
// a unique index so non-null values do not collide (multiple NULLs remain allowed).
